...
bool isValid(const vector<vector<int>>& r, const vector<int>& len, int optnum) {
...
int main() {
    ...
    int optnum = 0;
    vector<vector<int>> r(maxnum, vector<int>(w));
    vector<int> len(maxnum);
