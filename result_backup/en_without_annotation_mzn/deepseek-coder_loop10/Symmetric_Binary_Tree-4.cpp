...
void pushdown(int root, int i) {
    ...
    if (a[root][m] == i && ((l1 == -1 && (l2 == -1 || a[root][l2] == 0)) || (l2 == -1 && (l1 == -1 || a[root][l1] == 0)) || (l1 != -1 && l2 != -1 && a[root][l1] == l2 && a[root][l2] == l1)) &&
        ((r1 == -1 && (r2 == -1 || a[root][r2] == 0)) || (r2 == -1 && (r1 == -1 || a[root][r1] == 0)) || (r1 != -1 && r2 != -1 && a[root][r1] == r2 && a[root][r2] == r1))) {
